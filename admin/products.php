...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name,quantity, details, price,discount, image_01, image_02, image_03, category,sub_category) VALUES(?,?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$name,$quantity, $details, $price,$discount, $image_01, $image_02, $image_03, $category,$sub_category]);
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Available Quantity (required)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="ENter available Quantity" onkeypress="if(this.value.length == 10) return false;" name="quantity">
         </div>
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" class="box" required max="9999999999" placeholder="Enter discount in %" onkeypress="if(this.value.length == 10) return false;" name="discount">
         </div>

         <div class="flex">
            <div class="inputBox">
               <span>Category</span>
               <select id="category" style="padding:14px 35px" class="box" name="category" required>
         ...
         <div class="flex">
            <div class="inputBox">
               <span>Subcategory</span>
                  <select id="sub_category" style="padding:14px 35px" class="box" name="sub_category" required>
...
<script>
   ...
   // Initialize subcategories based on initial category selection
   updateSubcategories();
</script>
